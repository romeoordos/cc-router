...
export function MenuBar({ showAbout = false, showModels = false }: MenuBarProps): React.ReactElement {
  if (showAbout) {
    return (
      <Box flexDirection="column" alignItems="center" justifyContent="center" borderStyle="double" borderColor="cyan" paddingX={2} paddingY={1}>
        ...
        <Text> </Text>
        <Text>Version: <Text color="green">1.0.2</Text></Text>
        <Text> </Text>
  ...
  return (
    <Box borderStyle="single" borderColor="cyan" paddingX={1}>
      ...
      <Text dimColor> | </Text>
      <Text bold color="cyan" underline>Models</Text>
      <Text dimColor> | CC Router v1.0.2 - Intelligent API router</Text>
    </Box>
  );
}
